...
<!-- FRENCH-BLOG-POST-LIST:START -->
 ...
 - Jan 23, 2025 : [Azure Virtual Network Manager - Gérer vos IPS via un IPAM Azure built in](https://woivre.fr/blog/2025/01/azure-virtual-network-manager-gerer-vos-ips-via-un-ipam-azure-built-in)<!-- FRENCH-BLOG-POST-LIST:END -->
